...
const CHARACTERS = [
  ...
  { name: 'Гангстер Ballas (импорт из GTA San Andreas)', src: 'assets/models/gta-ballas.glb' },
  { name: 'Grove Street (импорт из GTA San Andreas)', src: 'assets/models/gta-grove.glb' },
  { name: 'Мент LAPD (импорт из GTA San Andreas)', src: 'assets/models/gta-cop.glb' },
];
