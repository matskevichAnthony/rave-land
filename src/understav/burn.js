 ...
 *
 * Горит на афише один знак события, но правило прожога вынесено из типографики намеренно:
 * это отдельный материал со своим шейдером, а не часть набора строк. `type.js` и без него
 * держит плиты, шкалу кеглей и раскладку, и лишние сто строк про раскалённое железо там
 * читаются посреди совсем другой работы.
 *
