...
//
// Порог опущен ради выхода в зал. Коридор это не место, а дорога к афише, и на 0.62 камень
// по дороге читался почти так же ярко, как зал в конце: подлёт приезжал из освещённого в
// освещённое, и афиша переставала быть событием. Ниже 0.4 уходит силуэт, поэтому 0.42.
const CORRIDOR_DIM = 0.42;
...
// Высота держится в рост бочки с четвертью. Втрое выше неё язык переставал читаться огнём
...
const BARREL_FIRE = { width: 1.05, height: 1.4, sink: 0.26, gain: 0.3, magnitude: 1.25, speed: 0.4 };
...
const FIRE_POOL = { radius: 3.2, opacity: 0.5, textureSize: 64, lift: 0.03, swing: 0.35 };
