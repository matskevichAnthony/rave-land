 ...
 *
 * По X ось уехала вправо вместе со всем ближним кластером: стоя над серединой дороги, она
 * приходилась ровно на стелы лайнапа и была видна одним хвостом выше букв. Четырнадцать
 * метров вправо выводят столб из-за типографики и заодно убирают воронку с проезжей части
 * аллеи. Число одно на весь кластер, и считано оно по углам афишного кадра.
 */
export const VORTEX = {
  x: 17.5,
  z: -24,
