 ...
 */
// Монумент стоит прямо, лицом вдоль оси ворот, а не вполоборота к камере: развёрнутый
// текст уводил композицию вбок и закрывал собой правую часть площадки.
const FACING_SHARE = 0;
