 ...
 *
 * Начертания сюда не заводятся: узкий гротеск плит и готика заголовка уже объявлены сценой,
 * и карточка обязана говорить теми же буквами, иначе она не серия со сценой, а соседний
 * макет. Отсюда импорт, а не свой список семейств.
 */

import { NARROW_FACE } from '../understav/text-texture.js';
import { gothicFaceFor } from '../understav/gothic.js';
import { createLayer } from './layer.js';

export { NARROW_FACE, gothicFaceFor };
...
export function fontOf(face, pixels) {
