 ...
 * повториться по сиду, а `Math.random` в движке даёт новую порчу на каждый вызов.
 */
...
/** Крест между словами: у движка это подпись готического пресета. */
export function crossMark(random) {
  return random.pick(CROSSES);
}
