...
export const COMBAT = {
  ...
  flinchSeconds: 0.35,
  // Крик на каждое попадание превращает перестрелку в непрерывный вой: попаданий в бою
  // куда больше, чем смертей. Поэтому раненый подаёт голос изредка и не чаще раза в
  // несколько секунд, а смерть кричит всегда, она одна на бойца.
  painChance: 0.2,
  painPauseSeconds: 4,
